const quizQuestions = [
    ...
    },
    {
        ...
        category: "세계지리",
        difficulty: "medium",
        question: "세계에서 가장 긴 강은? (전통적 측정 기준)",
        options: ["아마존강", "나일강", "양쯔강", "미시시피강"],
        correctAnswer: 1,
        explanation: "나일강은 약 6,650km로 전통적으로 세계에서 가장 긴 강으로 인정됩니다. (최근 연구에서는 아마존강이 더 길다는 주장도 있습니다)"
    },
    {
        id: 13,
        category: "세계지리",
