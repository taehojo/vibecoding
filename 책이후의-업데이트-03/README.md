...
스킬들이 모아져 있는 사이트는 꽤 많은데 그중에서 www.skills.sh라는 사이트를 보면 다음과 같이 스킬들이 설치된 숫자로 정렬되어 있어서 가장 잘 쓰이는 스킬들을 확인하고 수천개 이상의 스킬들 중에서 내게 필요한 것을 검색해 볼 수 있습니다.
