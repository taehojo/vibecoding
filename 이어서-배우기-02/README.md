# 책 이후의 업데이트-02 마켓플레이스(Marketplaces)로 플러그인 설치하고 나만의 스킬 만들기
...
내게 필요한 마켓플레이스를 Vibe Index 자료실에서 찾아보겠습니다. https://www.vibeindex.ai/ 에 접속합니다.

<img src="figures/update-02-22.png" width="700">
