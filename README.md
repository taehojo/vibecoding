...
📋 **[정오표 보기](정오표.pdf)** - 교재의 오탈자 및 수정 사항을 확인하세요.
...
**Chapter 2: 효과적인 프롬프트로 AI 200% 활용하기**
...
>
> **예제**: 손글씨 인식 프로그램 - MNIST 데이터셋을 활용한 숫자 인식 데스크톱 앱 + 웹 버전 확장 (계층적 폴더 구조 사용)

**Chapter 4: 클로드 코드 실전 활용**
...
> **예제**: 할 일 관리 앱 - 할 일 추가/수정/삭제, 카테고리 분류, 진행률 대시보드, 다크 모드 (웹 + PC 버전)

**Chapter 5: 게임 제작으로 배우는 체계적인 개발과 관리**
...
> **예제**: 상식 퀴즈 게임 - 4지선다 객관식, 카테고리별 모드, 점수 시스템, 리더보드 (할루시네이션 검증 가이드라인 적용, 커스텀 명령어 자동화)
...
> **예제**:
> - AI 공감 다이어리 앱: 하루 일기 입력 → 감정 분석 → 공감 메시지 생성 (에이전트 협업: 백엔드, 프론트, QA)
